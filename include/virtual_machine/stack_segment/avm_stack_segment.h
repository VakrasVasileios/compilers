...
namespace virtual_machine
{
    ...
    public:
         ...
         */
        memcell::AvmMemcell
          environment(const target_code::GlobalVmarg vmarg) const;
        /**
         * @brief Returns a read/write access to the avm memcell
         ...
         */
        memcell::AvmMemcell
          environment(const target_code::LocalVmarg vmarg) const;
        /**
         * @brief Returns a read/write access to the avm memcell
         ...
         */
        memcell::AvmMemcell
          environment(const target_code::FormalVmarg vmarg) const;
    private:
