...
expr:         assignexpr            {
            ...
            | expr '-' expr         {   
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            LOGERROR("Use of subtraction with non variable type");
                                        else if(entry1->get_type()!=CONTST_NUM || entry2->get_type()!=CONST_NUM)
                                            LOGWARNING("Entries must be type of Number");       
                                        else{
                                            auto _t1 = NewTemp(); 
            ...
            | expr '*' expr         {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            LOGERROR("Use of multiplication with non variable type");
                                        else if(entry1->get_type()!=CONTST_NUM || entry2->get_type()!=CONST_NUM)
                                            LOGWARNING("Entries must be type of Number");     
                                        else{
                                            auto _t1 = NewTemp(); 
            ...
            | expr '/' expr         {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            LOGERROR("Use of division with non variable type");
                                        else if(entry1->get_type()!=CONTST_NUM || entry2->get_type()!=CONST_NUM)
                                            LOGWARNING("Entries must be type of Number");       
                                        else{
                                            auto _t1 = NewTemp(); 
            ...
            | expr '%' expr         {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            LOGERROR("Use of modulo with non variable type");
                                        else if(entry1->get_type()!=CONTST_NUM || entry2->get_type()!=CONST_NUM)
                                            LOGWARNING("Entries must be type of Number");     
                                        else{
                                            auto _t1 = NewTemp(); 
            ...
            | expr '>' expr         {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            LOGERROR("Use of > with non variable type");
                                        else if(entry1->get_type()!=CONTST_NUM || entry2->get_type()!=CONST_NUM)
                                            LOGWARNING("Entries must be type of Number");   
                                        else{
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit(IF_GREATER_t, _t1, entry1, entry2, yylineno);
                                        } 
                                        DLOG("expr -> expr > expr");
                                    }
            | expr GEQL expr        {   
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit(IF_GREATEREQ_t, _t1, entry1, entry2, yylineno);
                                        } 
                                        DLOG("expr -> expr >= expr");
                                    }
            | expr '<' expr         {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit(IF_LESS_t, _t1, entry1, entry2, yylineno);
                                        } 
                                        DLOG("expr -> expr < expr");
                                    }
            | expr LEQL expr        {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit(IF_LESSEQ_t, _t1, entry1, entry2, yylineno);
                                        } 
                                        DLOG("expr -> expr <= expr");
                                    }
            | expr EQUAL expr       {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit(IF_EQ_t, _t1, entry1, entry2, yylineno);
                                        } 
                                        DLOG("expr -> expr == expr");
                                    }
            | expr NOTEQUAL expr    {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit(IF_NOTEQ_t, _t1, entry1, entry2, yylineno);
                                        } 
                                        DLOG("expr -> expr != expr");
                                    }
            | expr AND expr         {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            LOGERROR("Use of AND with non variable type");
                                        else if(entry1->get_type()!=CONTST_NUM || entry2->get_type()!=CONST_NUM)
                                            LOGWARNING("Entries must be type of Number");
                                        else{
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit( AND_t, _t1, entry1, entry2, yylineno);
                                        }
            ...
            | expr OR expr          {
                                        ...
                                        if(entry1 == nullptr)
                                            ...
                                            LOGERROR("Use of OR with non variable type");
                                        else if(entry1->get_type()!=CONTST_NUM || entry2->get_type()!=CONST_NUM)
                                            LOGWARNING("Entries must be type of Number");
                                        else{
                                            auto _t1 = NewTemp(); 
                                            $$ = _t1;
                                            Emit( OR_t, _t1, entry1, entry2, yylineno);
                                        }
