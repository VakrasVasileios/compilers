...
public:    
     ...
     * not null
     */
    virtual void        Accept(VmargVisitor* visitor) const = 0;
...
public:
    ...
    void        Accept(VmargVisitor* visitor) const override;
};
