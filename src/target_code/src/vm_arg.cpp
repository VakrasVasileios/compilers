...
void        
GlobalVmarg::Accept(VmargVisitor* visitor) const {
...
void        
LocalVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
FormalVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
BoolVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
StringVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
NumberVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
NilVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
LibFuncVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void       
UserFuncVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
LabelVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
...
void        
RetValVmarg::Accept(VmargVisitor* visitor) const {
    PRECONDITION(visitor != nullptr);
