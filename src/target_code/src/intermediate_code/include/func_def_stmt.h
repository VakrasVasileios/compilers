...
namespace target_code
{
    ...
    **/ 
    ...
    public:
        ...
        ~FuncDefStmt() = default;
        /**
         * @brief Returns a read access to this FuncDefStmt symbol that
         * is defined.
         * 
         * @return a read access to this FuncDefStmt symbol that is defined,
         * not null
        **/ 
        ...
        **/ 
         ...
         * 
         * @param patch_label the label to patch this FuncDefStmt jump quad
         * , that precedes this FuncDefStmt func start quad, not null and
         * greater or equal to zero.
        **/ 
        void                        PatchFuncStartJumpQuad(const unsigned
                                     int patch_label);
        /**
        ...
        **/ 
         ...
         * 
        **/ 
        void                        PatchReturnJumpQuads(const 
