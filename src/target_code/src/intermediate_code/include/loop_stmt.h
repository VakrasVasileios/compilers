    ...
    **/
    ...
    public:
        ...
        **/ 
         ...
         * to be pushed to this LoopStmt list of jump quads from continue
         * statements, not null and with Jump opcode.
        **/ 
        ...
        */ 
        ...
        /**
         * @brief Patches this LoopStmt list of jump quads from break
         * statements.
         * 
         * @param patch_label the label to patch this LoopStmt list of jump
         * quads from break statements, greater or equal to zero.
        **/ 
        void            PatchBreakJumpQuads(unsigned int patch_label);
        /**
         * @brief Patches this LoopStmt list of jump quads from continue
         * statements.
        **/ 
        virtual void    PatchContinueJumpQuads() = 0;
    protected:
        LoopStmt(LoopType _type, unsigned int first_quad_label)
            : Stmt(LOOP_t), loop_type(_type),
                first_quad_label(first_quad_label) {};
        ~LoopStmt() = default;
