...
TEST_F(InterCodeSuite, assign_simple)
{
    expected = "1: assign x 2 [line 1]\n"
               "2: assign ^0 x [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/assign/simple.asc");
...
TEST_F(InterCodeSuite, assign_calls_nested)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/assign/calls_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, assign_string)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/assign/string.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_single)
{
    expected = "1: jump 4 [line 1]\n"
               "2: funcstart f [line 1]\n"
               "3: funcend f [line 2]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/single.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_many)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/many.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_nested)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_shadowed)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/shadowed.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_anonymous)
{
    expected = "1: jump 10 [line 1]\n"
               ...
               "8: funcend $1 [line 5]\n"
               "9: funcend $0 [line 6]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/anonymous.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_warning)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_warning.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_noparameters)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_no_parameters.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_parameters)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_parameters.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_with_symbol_parameters)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_with_symbol_parameters.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_less_parameters)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_less_parameters.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_nested)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_more_parameters)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_more_parameters.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_function_def)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_function_def.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_nested_with_func_def)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_nested_with_func_def.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_anonymous_func_def)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_anonymous_func_def.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, functions_call_method_call) {
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/functions/call_method_call.asc");
    GTEST_ASSERT_EQ(expected, actual);            
}
...
TEST_F(InterCodeSuite, return_void)
{
    expected = "1: jump 6 [line 1]\n"
               ...
               "4: jump 5 [line 2]\n"
               "5: funcend f [line 3]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/return/return_void.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, return_symbol)
{
    expected = "1: jump 6 [line 5]\n"
               ...
               "4: jump 5 [line 6]\n"
               "5: funcend f [line 7]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/return/return_symbol.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, return_many_and_nested)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/return/return_many_and_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, logical_greater_simple)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/logical/greater_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, logical_equal_simple)
{
    expected = "1: if_eq 3 2 3 [line 1]\n"
               ...
               "4: jump 6 [line 1]\n"
               "5: assign ^0 'false' [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/logical/equal_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, logical_greater_equal_simple)
{
    expected = "1: if_greatereq 3 2 3 [line 1]\n"
               ...
               "4: jump 6 [line 1]\n"
               "5: assign ^0 'false' [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/logical/greater_equal_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, logical_less_equal_simple)
{
    expected = "1: if_lesseq 3 2 3 [line 1]\n"
               ...
               "4: jump 6 [line 1]\n"
               "5: assign ^0 'false' [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/logical/less_equal_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, logical_less_simple)
{
    expected = "1: if_less 3 2 3 [line 1]\n"
               ...
               "4: jump 6 [line 1]\n"
               "5: assign ^0 'false' [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/logical/less_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, logical_not_equal_simple)
{
    expected = "1: if_noteq 3 2 3 [line 1]\n"
               ...
               "4: jump 6 [line 1]\n"
               "5: assign ^0 'false' [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/logical/not_equal_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, logical_errors)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/logical/errors.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_while_simple)
{
    expected = "1: if_greater 2 6 3 [line 1]\n"
               ...
               "7: jump 9 [line 1]\n"
               "8: jump 1 [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/while_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_while_simple_with_stms)
{
    expected = "1: if_eq 1 'true' 3 [line 1]\n"
               ...
               "4: assign ^0 x [line 2]\n"
               "5: jump 1 [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/while_simple_with_stmts.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_while_many_nested)
{
    expected = "1: if_less x 0 3 [line 1]\n"
               ...
               "18: jump 20 [line 9]\n"
               "19: jump 17 [line 10]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/while_many_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_while_continue_single)
{
    expected = "1: if_eq 1 'true' 3 [line 1]\n"
               ...
               "3: jump 1 [line 2]\n"
               "4: jump 1 [line 3]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/while_continue_single.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_while_continue_many_nested)
{
    expected = "1: if_eq 1 'true' 3 [line 1]\n"
               ...
               "27: jump 16 [line 15]\n"
               "28: jump 1 [line 20]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/while_continue_many_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_while_break_single)
{
    expected = "1: if_eq 1 'true' 3 [line 1]\n"
               ...
               "3: jump 5 [line 2]\n"
               "4: jump 1 [line 3]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/while_break_single.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_for_simple)
{
    expected = "1: assign i 0 [line 1]\n"
               ...
               "12: jump 3 [line 1]\n"
               "13: jump 10 [line 2]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/for_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_for_simple_with_stmts)
{
    expected = "1: assign i 0 [line 1]\n"
               ...
               "15: jump 10 [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/for_simple_with_stmts.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_for_many_nested)
{
    expected =  "1: assign i 0 [line 1]\n"
                ...
                "51: jump 42 [line 6]\n"
                "52: jump 49 [line 6]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/for_many_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_for_continue_single)
{
    expected = "1: if_less i 0 3 [line 1]\n"
               ...
               "11: jump 8 [line 2]\n"
               "12: jump 8 [line 3]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/for_continue_single.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_for_continue_many_nested)
{
    expected =  "1: if_less i 0 3 [line 1]\n"
                ...
                "32: jump 26 [line 4]\n"
                "33: jump 8 [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/for_continue_many_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_for_break_single)
{
    expected = "1: if_less i 8 3 [line 1]\n"
               ...
               "11: jump 13 [line 2]\n"
               "12: jump 8 [line 3]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/for_break_single.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, loop_for_break_many_nested)
{
    expected =  "1: if_less i 8 3 [line 1]\n"
                ...
                "31: jump 26 [line 4]\n"
                "32: jump 8 [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/loop/for_break_many_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_simple)
{
    expected = "1: if_eq x 'true' 3 [line 1]\n"
               "2: jump 3 [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_expr)
{
    expected = "1: if_greater x 3 3 [line 1]\n"
               ...
               "6: if_eq ^0 'true' 8 [line 1]\n"
               "7: jump 8 [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_expr.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_stmts)
{
    expected = "1: if_less 3 x 3 [line 1]\n"
               ...
               "8: assign a f [line 5]\n"
               "9: assign ^1 a [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_stmts.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_nested_many)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_nested_many.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_else)
{
    expected = "1: if_eq a 'true' 3 [line 1]\n"
               ...
               "6: assign a x [line 2]\n"
               "7: assign ^0 a [line 2]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_else.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_elseif)
{
    expected = "1: if_eq 1 'true' 3 [line 1]\n"
               ...
               "8: assign x 3 [line 2]\n"
               "9: assign ^0 x [line 2]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_elseif.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_elseif_else)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_elseif_else.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, if_else_many_nested)
{
    expected =  "1: if_eq 1 'true' 3 [line 1]\n"
                ...
                "25: jump 27 [line 4]\n"
                "26: jump 27 [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/conditional/if_else_many_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_simple)
{
    expected = "1: add ^0 x 9 [line 1]\n"
               ...
               "4: mod ^0 3 6 [line 4]\n"
               "5: div ^0 1 1 [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_spaghetti)
{
    expected = "1: add ^0 x 9 [line 1]\n"
               ...
               "3: add ^2 ^1 9 [line 1]\n"
               "4: add ^3 ^2 u [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/spaghetti.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_errors)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/errors.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_plusplus_suffix)
{
    expected = "1: assign ^0 i [line 1]\n"
               "2: add i i 1 [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/plusplus_suffix.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_plusplus_prefix)
{
    expected = "1: add i i 1 [line 1]\n"
               "2: assign ^0 i [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/plusplus_prefix.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_uminus)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/uminus.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_uminus_bool) {
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/uminus_bool.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_not)
{
    expected = "1: if_eq 1 'true' 5 [line 1]\n"
               ...
               "4: jump 6 [line 1]\n"
               "5: assign ^0 'false' [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/not.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_minusminus_prefix)
{
    expected = "1: sub a a 1 [line 1]\n"
               "2: assign ^0 a [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/minusminus_prefix.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, arithmetic_minusminus_suffix)
{
    expected = "1: assign ^0 a [line 1]\n"
               "2: sub a a 1 [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/arithmetic/minusminus_suffix.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, table_tablemake_list_single)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tablemake_list_single.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, table_tablemake_list_many)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tablemake_list_many.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, table_tablemake_pairs_single)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tablemake_pairs_single.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, table_tablemake_pairs_many)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tablemake_pairs_many.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, table_tablemake_pairs_macaroni)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tablemake_pairs_macaroni.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, table_tablemake_nested)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tablemake_nested.asc");
    GTEST_ASSERT_EQ(expected, actual);
}

TEST_F(InterCodeSuite, table_tablemember_item_simple) {
    expected = "1: tablegetelem ^0 a \"o\" [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tablemember_item_simple.asc");
    GTEST_ASSERT_EQ(expected, actual); 
}
...
TEST_F(InterCodeSuite, table_tableelem_item_seq) {
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tableelem_item_seq.asc");
    GTEST_ASSERT_EQ(expected, actual); 
}        

TEST_F(InterCodeSuite, table_tableelem_ind_simp) {
    expected = "1: tablegetelem ^0 a 1 [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tableelem_ind_simp.asc");
    GTEST_ASSERT_EQ(expected, actual); 
}
...
TEST_F(InterCodeSuite, table_tablelem_ind_manyexprs) {
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tableelem_ind_manyexprs.asc");
    GTEST_ASSERT_EQ(expected, actual);            
}
...
TEST_F(InterCodeSuite, table_tableelem_it_call) {
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tableelem_it_call.asc");
    GTEST_ASSERT_EQ(expected, actual);            
}
...
TEST_F(InterCodeSuite, table_tebleelem_ind_call) {
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/tableelem_ind_call.asc");
    GTEST_ASSERT_EQ(expected, actual);              
}
...
TEST_F(InterCodeSuite, table_emit_iftableitem_plusplusprefix) {
    ...
    actual =  util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/emit_iftableitem_plusplusprefix.asc");     
    GTEST_ASSERT_EQ(expected, actual);     
}
...
TEST_F(InterCodeSuite, table_emit_iftableitem_plusplussufix) {
    ...
    actual =  util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/emit_iftableitem_plusplussufix.asc");     
    GTEST_ASSERT_EQ(expected, actual);            
}
...
TEST_F(InterCodeSuite, table_emit_iftableitem_minusminus_prefix) {
    expected =  "1: tablegetelem ^1 a 2 [line 1]\n"
                "2: sub ^1 ^1 1 [line 1]\n"
                "3: tablesetelem a 2 ^1 [line 1]\n";
    actual =  util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/emit_iftableitem_minusminus_prefix.asc");     
    GTEST_ASSERT_EQ(expected, actual);            
}
...
TEST_F(InterCodeSuite, table_emit_iftableitem_minusminus_suffix) {
    expected =  "1: tablegetelem ^1 a 2 [line 1]\n"
                ...
                "3: sub ^1 ^1 1 [line 1]\n"
                "4: tablesetelem a 2 ^1 [line 1]\n";
    actual =  util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/emit_iftableitem_minusminus_suffix.asc");     
    GTEST_ASSERT_EQ(expected, actual);            
}
...
TEST_F(InterCodeSuite, table_emit_iftableitem_assignexpr) {
    ...
    actual =  util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/emit_iftableitem_assignexpr.asc");     
    GTEST_ASSERT_EQ(expected, actual);            
}
...
TEST_F(InterCodeSuite, table_emit_iftableitem_call) {
    expected =  "1: tablegetelem ^0 a 3 [line 1]\n"
                ...
                "3: call ^0 [line 1]\n"
                "4: getretval ^1 [line 1]\n";
    actual =  util::exec::exec("../src/d_intermediate_code files/phase3_tests/table/emit_iftableitem_call.asc");     
    GTEST_ASSERT_EQ(expected, actual);              
}
...
TEST_F(InterCodeSuite, short_circuit_simple_or)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/short_circuit/simple_or.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_backpatch0)
{
    expected = "1: if_eq a 'true' 3 [line 1]\n"
               ...
               "8: assign x ^0 [line 1]\n"
               "9: assign ^1 x [line 1]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/backpatch0.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_backpatch1)
{
    expected = "1: if_eq a 'true' 7 [line 1]\n"
               ...
               "15: jump 1 [line 2]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/backpatch1.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_backpatch2)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/backpatch2.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_backpatch3)
{
    expected = "\x1B[33mWarning, in line: 8:\x1B[0m Too many arguments passed to function: $0, defined in line: 8\n"
               ...
               "113: jump 97 [line 22]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/backpatch3.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_assignments_complex)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_assignments_complex.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_assignments_objects)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_assignments_objects.asc");
    GTEST_ASSERT_EQ(expected, actual);   
}
...
TEST_F(InterCodeSuite, backpatch_p3t_assignments_simple)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_assignments_simple.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_var_maths)
{
    expected =  "1: add ^0 x y [line 1]\n"
                ...
                "4: div ^0 u v [line 4]\n"
                "5: mod ^0 r l [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_var_maths.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_relational)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_relational.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_object_creation_expr)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_object_creation_expr.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_if_else)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_if_else.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_funcdecl)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_funcdecl.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_flow_control)
{
    expected =  "1: assign a 1 [line 1]\n"
                ...
                "56: jump 50 [line 27]\n"
                "57: jump 50 [line 28]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_flow_control.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_flow_control_error)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_flow_control_error.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_const_maths)
{
    expected =  "1: add ^0 4 5 [line 1]\n"
                ...
                "4: div ^0 3 1 [line 4]\n"
                "5: mod ^0 0 3 [line 5]\n";
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_const_maths.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_basic_expr)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_basic_expr.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
...
TEST_F(InterCodeSuite, backpatch_p3t_calls)
{
    ...
    actual = util::exec::exec("../src/d_intermediate_code files/phase3_tests/backpatch/p3t_calls.asc");
    GTEST_ASSERT_EQ(expected, actual);
}
